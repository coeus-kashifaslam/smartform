$(document).ready(function (){
    ...
    var ratingContinuous = $('.rating-comp__selection-type__continuous > li .ranking__list__item__label');
    var ratingsingle = $('.rating-comp__selection-type__single > li .ranking__list__item__label');
    var ratingListItem = $('.no-touch .rating-comp__icons-list > li .ranking__list__item__label');
    ...
    $(document).on('click','.rating-comp__selection-type__continuous.rating-comp__selection-type__total > li .ranking__list__item__label', function () {
        var $this = $(this);
        $this.closest(ratingList).find('> li').removeClass('rating-comp__hover rating-comp__hover__current rating-comp__selected');
        $this.parent().addClass('rating-comp__selected');
        $this.parent().prevAll().addClass('rating-comp__selected');
    });
    $(document).on('click', '.rating-comp__selection-type__single.rating-comp__selection-type__total > li .ranking__list__item__label' ,function () {
        var $this = $(this);
        $this.closest(ratingList).find('> li').removeClass('rating-comp__hover rating-comp__hover__current rating-comp__selected');
        $this.parent().addClass('rating-comp__selected');
    });
